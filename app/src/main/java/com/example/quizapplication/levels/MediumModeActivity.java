...
import com.example.quizapplication.model.QuestionMediumMode;
import com.example.quizapplication.uiactivities.ScoreActivity;

public class MediumModeActivity extends AppCompatActivity implements OnClickListener {
    ...
    int score = 0;
    int totalQuestion = QuestionMediumMode.question.length;
    ...
    public void onClick(View view) {
        ...
        if (clickedButton.getId() == R.id.submit_btn) {
            if (selectedAnswer.equals(QuestionMediumMode.correctAnswers[currentQuestionIndex])) {
                score++;
            }
    ...
    void loadNewQuestion() {
        ...
        questionTextView.setText(QuestionMediumMode.question[currentQuestionIndex]);
        ansA.setText(QuestionMediumMode.choices[currentQuestionIndex][0]);
        ansB.setText(QuestionMediumMode.choices[currentQuestionIndex][1]);
        ansC.setText(QuestionMediumMode.choices[currentQuestionIndex][2]);
        ansD.setText(QuestionMediumMode.choices[currentQuestionIndex][3]);
    }
    ...
    void finishQuiz() {
        ...
        Intent scoreIntent = new Intent(MediumModeActivity.this, ScoreActivity.class);
        ...
        scoreIntent.putExtra("gameMode", "Medium");
